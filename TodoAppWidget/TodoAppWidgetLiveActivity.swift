...
struct TodoAppWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = TodoAppWidgetAttributes(name: "Me")
    static let contentState = TodoAppWidgetAttributes.ContentState(value: 3)
